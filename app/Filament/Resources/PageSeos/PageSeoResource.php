...
class PageSeoResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'SEO de page';

    protected static ?string $pluralModelLabel = 'SEO des pages';

    protected static ?string $navigationLabel = 'SEO des pages';
